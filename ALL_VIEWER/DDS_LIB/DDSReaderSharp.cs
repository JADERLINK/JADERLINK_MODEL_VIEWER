...
public class DDSReaderSharp
{
    ...
    public static Bitmap ToBitmap(byte[] DDSFile)
    {
        int Width = GetWidth(DDSFile);
        int Height = GetHeight(DDSFile);
        int[] PixelsData = Read(DDSFile, ARGB, 0);
    ...
    static int[] decodeDXT1(int width, int height, int offset, byte[] buffer, Order order)
    {
    ...
    static int[] decodeDXT2(int width, int height, int offset, byte[] buffer, Order order)
    {
        return decodeDXT3(width, height, offset, buffer, order);
    }

    static int[] decodeDXT3(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int w = (width + 3) / 4;
        int h = (height + 3) / 4;
    ...
    static int[] decodeDXT4(int width, int height, int offset, byte[] buffer, Order order)
    {
        return decodeDXT5(width, height, offset, buffer, order);
    }

    static int[] decodeDXT5(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int w = (width + 3) / 4;
        int h = (height + 3) / 4;
    ...
    static int[] readA1R5G5B5(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
    ...
    static int[] readX1R5G5B5(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    static int[] readA4R4G4B4(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    static int[] readX4R4G4B4(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    static int[] readR5G6B5(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    static int[] readR8G8B8(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    static int[] readA8B8G8R8(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    static int[] readX8B8G8R8(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    static int[] readA8R8G8B8(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    static int[] readX8R8G8B8(int width, int height, int offset, byte[] buffer, Order order)
    {
        int index = offset;
        int[] pixels = new int[width * height];
        for (int i = 0; i < height * width; i++)
    ...
    // Image Type
    const int DXT1 = 0x44585431;
    const int DXT2 = 0x44585432;
    const int DXT3 = 0x44585433;
    const int DXT4 = 0x44585434;
    const int DXT5 = 0x44585435;
    const int A1R5G5B5 = 0x10002;
    const int X1R5G5B5 = 0x20002;
    const int A4R4G4B4 = 0x30002;
    const int X4R4G4B4 = 0x40002;
    const int R5G6B5 = 0x50002;
    const int R8G8B8 = 0x10003;
    const int A8B8G8R8 = 0x10004;
    const int X8B8G8R8 = 0x20004;
    const int A8R8G8B8 = 0x30004;
    const int X8R8G8B8 = 0x40004;
    ...
    static int[] A8B8G8R8_MASKS = { 0x000000FF, 0x0000FF00, 0x00FF0000, 0xFF0000 << 8 };
    static int[] X8B8G8R8_MASKS = { 0x000000FF, 0x0000FF00, 0x00FF0000, 0x00000000 };
    static int[] A8R8G8B8_MASKS = { 0x00FF0000, 0x0000FF00, 0x000000FF, 0xFF0000 << 8 };
    static int[] X8R8G8B8_MASKS = { 0x00FF0000, 0x0000FF00, 0x000000FF, 0x00000000 };

    // BIT4 = 17 * index;
    static int[] BIT5 = { 0, 8, 16, 25, 33, 41, 49, 58, 66, 74, 82, 90, 99, 107, 115, 123, 132, 140, 148, 156, 165, 173, 181, 189, 197, 206, 214, 222, 230, 239, 247, 255 };
    static int[] BIT6 = { 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 45, 49, 53, 57, 61, 65, 69, 73, 77, 81, 85, 89, 93, 97, 101, 105, 109, 113, 117, 121, 125, 130, 134, 138, 142, 146, 150, 154, 158, 162, 166, 170, 174, 178, 182, 186, 190, 194, 198, 202, 206, 210, 215, 219, 223, 227, 231, 235, 239, 243, 247, 251, 255 };
