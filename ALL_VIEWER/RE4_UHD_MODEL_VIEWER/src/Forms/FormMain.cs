...
namespace RE4_UHD_MODEL_VIEWER
{
    public partial class FormMain : Form
    {
        ...
        private void openFileDialogBINTPL_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadUhdBinModel loadBinModel = new LoadUhdBinModel(modelGroup, mng, false, SimpleEndianBinaryIO.Endianness.LittleEndian);
            LoadUhdTpl loadTpl = new LoadUhdTpl(modelGroup, mng, false, SimpleEndianBinaryIO.Endianness.LittleEndian);
        ...
        private void openFileDialogSMD_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadUhdScenarioSMD loadScenarioSMD = new LoadUhdScenarioSMD(modelGroup, sng, false, SimpleEndianBinaryIO.Endianness.LittleEndian);
