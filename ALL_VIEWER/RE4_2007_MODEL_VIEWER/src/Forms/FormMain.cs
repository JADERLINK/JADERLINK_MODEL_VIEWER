...
namespace RE4_2007_MODEL_VIEWER
{
    public partial class FormMain : Form
    {
        ...
        private void toolStripMenuItemLoadPmd_Click(object sender, EventArgs e)
        {
            openFileDialogPMD.ShowDialog();
        }
        ...
        private void toolStripMenuItemLoadTga_Click(object sender, EventArgs e)
        {
            openFileDialogTGA.ShowDialog();
        }

        private void openFileDialogPMD_FileOk(object sender, CancelEventArgs e)
        {
            treeViewObjs.SuspendLayout();

            LoadPmdModel loadPmdModel = new LoadPmdModel(modelGroup, mng, tpng);
            for (int i = 0; i < openFileDialogPMD.FileNames.Length; i++)
            {
                loadPmdModel.LoadPMD(openFileDialogPMD.FileNames[i]);
            }
        ...
        private void openFileDialogTGA_FileOk(object sender, CancelEventArgs e)
        {
            treeViewObjs.SuspendLayout();

            LoadTGA loadTGA = new LoadTGA(modelGroup, tpng);
            loadTGA.LoadTga(openFileDialogTGA.FileNames);
        ...
        private void openFileDialogSMD_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadScenarioSMD loadScenarioSMD = new LoadScenarioSMD(modelGroup, sng);
