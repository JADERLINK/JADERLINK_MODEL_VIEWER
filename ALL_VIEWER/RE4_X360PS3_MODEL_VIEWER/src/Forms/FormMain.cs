...
namespace RE4_X360PS3_MODEL_VIEWER
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            sng = new ScenarioNodeGroup("X360/PS3 SCENARIO");
            ...
            {
                openFileDialogBINTPL.Filter = MultiPlatformOS.LinuxFileDialogHelper.BuildLinuxFilterFromFilter(openFileDialogBINTPL.Filter);
                ...
                openFileDialogPACK.Filter = MultiPlatformOS.LinuxFileDialogHelper.BuildLinuxFilterFromFilter(openFileDialogPACK.Filter);
            }
        }
        ...
        private void toolStripMenuItemLoadPACK_X360_Click(object sender, EventArgs e)
        {
            isPS3Pack = false;
            openFileDialogPACK.ShowDialog();
        }
        private void toolStripMenuItemLoadPACK_PS3_Click(object sender, EventArgs e)
        {
            isPS3Pack = true;
            openFileDialogPACK.ShowDialog();
        }
        ...
        private void openFileDialogBINTPL_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadUhdBinModel loadBinModel = new LoadUhdBinModel(modelGroup, mng, false, SimpleEndianBinaryIO.Endianness.BigEndian);
            LoadUhdTpl loadTpl = new LoadUhdTpl(modelGroup, mng, false, SimpleEndianBinaryIO.Endianness.BigEndian);
        ...
        bool isPS3Pack = false;

        private void openFileDialogPACK_FileOk(object sender, CancelEventArgs e)
        {
            treeViewObjs.SuspendLayout();

            LoadX360PS3Pack loadPACK = new LoadX360PS3Pack(modelGroup, tpng, isPS3Pack);
        ...
        private void openFileDialogSMD_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadUhdScenarioSMD loadScenarioSMD = new LoadUhdScenarioSMD(modelGroup, sng, false, SimpleEndianBinaryIO.Endianness.BigEndian);
        ...
        private void openFileDialogSMX_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadSMX loadSMX = new LoadSMX(modelGroup, sng, SimpleEndianBinaryIO.Endianness.BigEndian);
