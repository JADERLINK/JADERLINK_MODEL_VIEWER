...
namespace RE4_X360PS3_MODEL_VIEWER.src
{
    public class LoadX360PS3Pack
    {
        private ModelGroup modelGroup;
        private TexturePackNodeGroup tpng;
        private bool isPS3Pack;

        public LoadX360PS3Pack(ModelGroup modelGroup, TexturePackNodeGroup tpng, bool isPS3Pack)
        {
            this.modelGroup = modelGroup;
            this.tpng = tpng;
            this.isPS3Pack = isPS3Pack;
        }

        public void LoadPack(string packPath)
        {
            EndianBinaryReader pack = null;

            try
            {
                FileInfo fileInfo = new FileInfo(packPath);
                pack = new EndianBinaryReader(fileInfo.OpenRead(), Endianness.BigEndian);
