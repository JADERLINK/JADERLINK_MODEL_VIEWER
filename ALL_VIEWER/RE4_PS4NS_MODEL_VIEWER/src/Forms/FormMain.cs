...
using ViewerBase;
using ShaderLoader;
using RE4_PS4NS_MODEL_VIEWER.src;
...
namespace RE4_PS4NS_MODEL_VIEWER
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            sng = new ScenarioNodeGroup("PS4/NS SCENARIO");
        ...
        private void openFileDialogBINTPL_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadUhdBinModel loadBinModel = new LoadUhdBinModel(modelGroup, mng, true, SimpleEndianBinaryIO.Endianness.LittleEndian);
            LoadUhdTpl loadTpl = new LoadUhdTpl(modelGroup, mng, true, SimpleEndianBinaryIO.Endianness.LittleEndian);
        ...
        private void openFileDialogPACK_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadPs4NsPack loadPACK = new LoadPs4NsPack(modelGroup, tpng);
        ...
        private void openFileDialogSMD_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadUhdScenarioSMD loadScenarioSMD = new LoadUhdScenarioSMD(modelGroup, sng, true, SimpleEndianBinaryIO.Endianness.LittleEndian);
        ...
        private void openFileDialogSMX_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadSMX loadSMX = new LoadSMX(modelGroup, sng, SimpleEndianBinaryIO.Endianness.LittleEndian);
