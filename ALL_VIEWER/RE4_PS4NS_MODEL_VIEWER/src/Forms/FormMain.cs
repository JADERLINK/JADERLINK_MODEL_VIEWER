...
namespace RE4_PS4NS_MODEL_VIEWER
{
    public partial class FormMain : Form
    {
        ...
        private void openFileDialogBINTPL_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadUhdBinModel loadBinModel = new LoadUhdBinModel(modelGroup, mng, true);
            LoadUhdTpl loadTpl = new LoadUhdTpl(modelGroup, mng, true);
        ...
        private void openFileDialogSMD_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadUhdScenarioSMD loadScenarioSMD = new LoadUhdScenarioSMD(modelGroup, sng, true);
