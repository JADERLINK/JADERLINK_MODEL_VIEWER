...
using RE4_GCWII_MODEL_VIEWER.src;
...
namespace RE4_GCWII_MODEL_VIEWER
{
    public partial class FormMain : Form
    {
        ...
        private void openFileDialogBINTPL_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadGcWiiBinModel loadBinModel = new LoadGcWiiBinModel(modelGroup, mng);
            for (int i = 0; i < openFileDialogBINTPL.FileNames.Length; i++)
            {
                ...
                {
                    loadBinModel.LoadGcWiiBIN(file);
                }
        ...
        private void openFileDialogSMD_FileOk(object sender, CancelEventArgs e)
        {
            ...
            LoadGcWiiScenarioSMD loadScenarioSMD = new LoadGcWiiScenarioSMD(modelGroup, sng);
